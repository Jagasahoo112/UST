function initTextToSpeech() {
  ...
  var highlightDiv;
  var startSynthesisAsyncButton, pauseButton, resumeButton, resetButton;
  ...
  window.setTimeout(function () {
    ...
    setInterval(function () {
      if (player !== undefined) {
        ...
        if (wordBoundary !== undefined) {
          // highlightDiv.innerHTML = synthesisText.substr(0, wordBoundary.textOffset) +
          //         "<span class='bg-warning'>" + wordBoundary.text + "</span>" +
          //         synthesisText.substr(wordBoundary.textOffset + wordBoundary.wordLength);
          let htmlText =
      ...
      if (currentPathname != "/#/demos/text-speech-conversion") {
        if (player !== undefined) {
          player.pause();
    ...
    startSynthesisAsyncButton.addEventListener("click", function () {
      ...
      synthesisText = document.getElementById("synthesisText").innerText;
  ...
  resetFields.addEventListener("click", function () {
    ...
    pauseButton.style.display = "none";
    resumeButton.style.display = "none";
    document.getElementById("synthesisText").innerText = "";
    var slider = document.getElementById("speed");
    slider.value = 0;
